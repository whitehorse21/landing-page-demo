...
const BrowseCities = () => {
  ...
  const [displayCount, setDisplayCount] = useState(9) // Show 9 cities initially
      ...
      {hasMore && (
        <div className="flex justify-center mt-8">
          <button
            ...
            className="px-6 py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg font-medium transition-colors shadow-md hover:shadow-lg"
          >

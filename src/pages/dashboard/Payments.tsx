  ...
  const transactions = [
    {
      id: 1,
      type: 'Payment',
      descriptionKey: 'dashboard.payments.descriptions.parisTrip',
      amount: '-$1,200',
      date: '2026-01-15',
      status: 'Completed',
      method: 'Credit Card',
    },
    {
      id: 2,
      type: 'Refund',
      descriptionKey: 'dashboard.payments.descriptions.cancelledLondonTrip',
      amount: '+$1,400',
      date: '2025-12-20',
      status: 'Completed',
      method: 'Credit Card',
    },
    {
      id: 3,
      type: 'Payment',
      descriptionKey: 'dashboard.payments.descriptions.tokyoTrip',
      amount: '-$2,100',
      date: '2026-01-20',
      status: 'Pending',
      method: 'PayPal',
    },
    {
      id: 4,
      type: 'Payment',
      descriptionKey: 'dashboard.payments.descriptions.barcelonaTrip',
      amount: '-$950',
      date: '2025-11-10',
      status: 'Completed',
      method: 'Credit Card',
    },
    {
      id: 5,
      type: 'Payment',
      descriptionKey: 'dashboard.payments.descriptions.romeTrip',
      amount: '-$1,350',
      date: '2025-10-25',
      status: 'Completed',
      method: 'Debit Card',
    },
    {
      id: 6,
      type: 'Payment',
      descriptionKey: 'dashboard.payments.descriptions.dubaiTrip',
      amount: '-$2,500',
      date: '2025-10-15',
      status: 'Completed',
      method: 'Credit Card',
    },
    {
      id: 7,
      type: 'Refund',
      descriptionKey: 'dashboard.payments.descriptions.cancelledRomeTrip',
      amount: '+$1,350',
      date: '2025-10-28',
      status: 'Completed',
      method: 'Credit Card',
    },
    {
      id: 8,
      type: 'Payment',
      descriptionKey: 'dashboard.payments.descriptions.newYorkTrip',
      amount: '-$1,800',
      date: '2025-09-20',
      status: 'Completed',
      method: 'PayPal',
    },
    {
      id: 9,
      type: 'Payment',
      descriptionKey: 'dashboard.payments.descriptions.sydneyTrip',
      amount: '-$2,300',
      date: '2025-09-10',
      status: 'Completed',
      method: 'Credit Card',
    },
    {
      id: 10,
      type: 'Payment',
      descriptionKey: 'dashboard.payments.descriptions.baliTrip',
      amount: '-$1,100',
      date: '2025-08-25',
      status: 'Completed',
      method: 'Debit Card',
    },
    {
      id: 11,
      type: 'Payment',
      descriptionKey: 'dashboard.payments.descriptions.santoriniTrip',
      amount: '-$1,650',
      date: '2025-08-15',
      status: 'Completed',
      method: 'Credit Card',
    },
    {
      id: 12,
      type: 'Payment',
      descriptionKey: 'dashboard.payments.descriptions.amsterdamTrip',
      amount: '-$1,400',
      date: '2025-07-20',
      status: 'Completed',
      method: 'Debit Card',
    },
    {
      id: 13,
      type: 'Payment',
      descriptionKey: 'dashboard.payments.descriptions.pragueTrip',
      amount: '-$1,200',
      date: '2025-07-10',
      status: 'Completed',
      method: 'Credit Card',
    },
    {
      id: 14,
      type: 'Payment',
      descriptionKey: 'dashboard.payments.descriptions.viennaTrip',
      amount: '-$1,550',
      date: '2025-06-25',
      status: 'Completed',
      method: 'PayPal',
    },
    {
      id: 15,
      type: 'Refund',
      descriptionKey: 'dashboard.payments.descriptions.cancelledAmsterdamTrip',
      amount: '+$1,400',
      date: '2025-07-22',
      status: 'Completed',
      method: 'Credit Card',
    },
    {
      id: 16,
      type: 'Payment',
      descriptionKey: 'dashboard.payments.descriptions.istanbulTrip',
      amount: '-$1,300',
      date: '2025-06-15',
      status: 'Completed',
      method: 'Credit Card',
    },
    {
      id: 17,
      type: 'Payment',
      descriptionKey: 'dashboard.payments.descriptions.lisbonTrip',
      amount: '-$1,100',
      date: '2025-05-30',
      status: 'Completed',
      method: 'Debit Card',
    },
    {
      id: 18,
      type: 'Payment',
      descriptionKey: 'dashboard.payments.descriptions.athensTrip',
      amount: '-$1,250',
      date: '2025-05-20',
      status: 'Completed',
      method: 'Credit Card',
    },
    {
      id: 19,
      type: 'Refund',
      descriptionKey: 'dashboard.payments.descriptions.cancelledPragueTrip',
      amount: '+$1,200',
      date: '2025-07-12',
      status: 'Completed',
      method: 'Credit Card',
    },
    {
      id: 20,
      type: 'Payment',
      descriptionKey: 'dashboard.payments.descriptions.londonTrip',
      amount: '-$1,400',
      date: '2025-05-10',
      status: 'Completed',
      method: 'PayPal',
